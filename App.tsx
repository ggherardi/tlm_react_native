...
import { faCalendarDay, faCalendarWeek, faCamera, faPlus, faTable, faTableCells, faTableCellsLarge, faTableColumns, faTableList, faTableTennis, faTimeline, faTrash, faUpload } from '@fortawesome/free-solid-svg-icons';
